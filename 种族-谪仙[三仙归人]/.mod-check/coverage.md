...
### Partially read
- `Public/XSS_BANXIAN/Races/Races.lsx` (7069 lines; structure + UUID cross-refs verified)
...
- `Public/XSS_BANXIAN/RootTemplates/_merged.lsf.lsx` (2372 lines; 96 GameObjects, MapKeys + race UUIDs verified)
